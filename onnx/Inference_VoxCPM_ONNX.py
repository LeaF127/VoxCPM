...
onnx_model_A = r'../models/VoxCPM_Optimized/VoxCPM_Text_Embed.onnx'       # Assign a path where the exported VoxCPM model stored.
onnx_model_B = r'../models/VoxCPM_Optimized/VoxCPM_VAE_Encoder.onnx'
onnx_model_C = r'../models/VoxCPM_Optimized/VoxCPM_Feat_Encoder.onnx'
onnx_model_D = r'../models/VoxCPM_Optimized/VoxCPM_Feat_Cond.onnx'
onnx_model_E = r'../models/VoxCPM_Optimized/VoxCPM_Concat.onnx'
onnx_model_F = r'../models/VoxCPM_Optimized/VoxCPM_Main.onnx'
onnx_model_G = r'../models/VoxCPM_Optimized/VoxCPM_Feat_Decoder.onnx'
onnx_model_H = r'../models/VoxCPM_Optimized/VoxCPM_VAE_Decoder.onnx'
...
MAX_THREADS = 3                          # Parallel CPU threads, 0 for auto
